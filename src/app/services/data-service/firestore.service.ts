...
export class FirestoreService implements AbstractDataService {
    ...
    private _householdsCollection = this._angularFirestore.collection<Household>(
        'households'
    );
    ...
    public deleteItem(itemKey: string): void {
        this._itemsCollection.doc(itemKey).delete();
    }
    ...
    public deleteCategory(categoryKey: string): void {
        this._categoriesCollection.doc(categoryKey).delete();
    }
